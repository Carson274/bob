    ...
    <div className='container'>
      {pageNumber === 1 && (
        <>
          ...
          <img src='4.gif' alt='Page 1 GIF' className='page-gif' />
      ...
      {pageNumber === 2 && (
        <>
          ...
          <img src='5.gif' alt='Page 2 GIF' className='page-gif' />
      ...
      {pageNumber === 3 && (
        <>
          ...
          <img src='7.gif' alt='Page 3 GIF' className='page-gif' />
          <input
            type='text'
            value={flowerName}
      ...
      {pageNumber === 4 && (
        <>
          ...
          <img src='6.gif' alt='Page 4 GIF' className='page-gif' />
          <label>
            <input
              type='checkbox'
              checked={creditCard}
      ...
      {pageNumber === 5 && (
        <>
          ...
          <img src='8.gif' alt='Page 5 GIF' className='page-gif' />
